...
namespace App\Http\Requests\Dashboard\Tabs;
...
class StoreTabRequest extends FormRequest
{
    ...
    {
        return [
            'name_en.required' => __('dashboard.name_en').' '.__('dashboard.is_required'),
            'name_ar.required' => __('dashboard.name_ar').' '.__('dashboard.is_required'),
            'name_en.max' => __('dashboard.name_en').' '.__('dashboard.max_255'),
            'name_ar.max' => __('dashboard.name_ar').' '.__('dashboard.max_255'),
