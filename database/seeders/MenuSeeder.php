...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [
                'name_en' => 'Previous Projects',
                'name_ar' => 'المشاريع السابقة',
                'route_name' => MenuRouteName::PREVIOUS_PROJECTS->value,
                'parent_id' => null,
                'order' => 4,
                'status' => true,
            ],
            [
                'name_en' => 'Media',
                'name_ar' => 'الوسائط',
                'route_name' => MenuRouteName::MEDIA->value,
                'parent_id' => null,
                'order' => 5,
                'status' => true,
            ],
            ...
            [
                'name_en' => 'Videos',
                'name_ar' => 'الفيديوهات',
                'route_name' => MenuRouteName::VIDEOS->value,
                'parent_id' => null,
                'order' => 5,
                'status' => true,
            ]
