                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="page-title-right d-flex justify-content-end">
                            <x-dashboard.partials.action-buttons createUrl="{{ route('dashboard.blog_categories.create') }}" />
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr id="{{ $category->id }}">
                                    ...
                                    <td><a href="{{ route('dashboard.blog_categories.edit', $category->id) }}">{{ $category->id}}</a></td>
                                    <td><a href="{{ route('dashboard.blog_categories.edit', $category->id) }}">{{$category->name_en }}</a></td>
                                    <td><a href="{{ route('dashboard.blog_categories.edit', $category->id) }}">{{
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.blog_categories.edit', $category->id) }}" class="status">
