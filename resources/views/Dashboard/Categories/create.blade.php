<x-dashboard.layout :title="__('dashboard.add_category')">

    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="__('dashboard.add_category')" :label_url="route('dashboard.categories.index')" :label="__('dashboard.categories')" />
    <!-- End Page Header -->
        ...
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">{{ __('dashboard.add_category') }}</h4>
                </div>
