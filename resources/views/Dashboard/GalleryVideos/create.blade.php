<x-dashboard.layout :title="__('dashboard.add_video')">

    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="__('dashboard.add_video')" :label_url="route('dashboard.gallery_videos.index')" :label="__('dashboard.gallery_videos')" />
    <!-- End Page Header -->
        ...
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-header">
                    <h4 class="card-title">{{ __('dashboard.add_video') }}</h4>
                </div>

                <div class="card-body">

                    <form action="{{ route('dashboard.gallery_videos.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                               ...
                               <div class="form-group col-md-12">
                                ...
                                <input class="form-control" name="video_url" type="text" value="{{old('video_url')}}" placeholder="{{__('dashboard.video_url')}}" >
                            </div>
