                        ...
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            <thead>
                             ...
                             <tbody>
                                ...
                                <tr id="{{ $plan->id }}">
                                    <td><input type="checkbox" name="checkbox" class="form-check-input check-inputs" value="{{ $plan->id }}" /></td>
                                    <td><a href="{{ route('dashboard.plans.edit', $plan->id) }}">{{ $plan->id}}</a></td>
                                    <td><a href="{{ route('dashboard.plans.edit', $plan->id) }}">{{$plan->name_en }}</a></td>
                                    <td><a href="{{ route('dashboard.plans.edit', $plan->id) }}">{{
                                            $plan->name_ar }}</a></td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('dashboard.plans.edit', $plan->id) }}" class="status">
                                            @if($plan->status == 1) {{ __('dashboard.yes') }} @else {{
