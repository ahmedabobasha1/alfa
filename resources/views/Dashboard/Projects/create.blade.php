                    ...
                    <form action="{{ route('dashboard.projects.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <label for="select_category">{{__('dashboard.select_category')}}</label>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <a href="{{route('dashboard.projects.index')}}"><button type="button" class="btn btn-danger mr-1"><i class="icon-trash"></i>
