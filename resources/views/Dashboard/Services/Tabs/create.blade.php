<x-dashboard.layout :title="$service->name . ' ' . __('dashboard.add_tab')">

    <!-- Page Header -->
    <x-dashboard.partials.page-header :header="$service->name . ' ' . __('dashboard.add_tab')" :label_url="route('dashboard.services.edit', $service->id)" :label="$service->name . ' ' . __('dashboard.tabs')" />
    <!-- End Page Header -->
        ...
        <div class="col-sm-12 col-xl-12 col-lg-12">
            <div class="card custom-card overflow-hidden">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.services.tabs.store', $service->id) }}" method="POST"
