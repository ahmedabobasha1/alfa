                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="">{{__('dashboard.job_title_en')}}</label>
                                <input class="form-control" name="job_title_en" type="text" value="{{old('job_title_en')}}" placeholder="{{__('dashboard.job_title_en')}}" >
                            </div>

                            <div class="form-group col-md-6">
                                <label class="">{{__('dashboard.job_title_ar')}}</label>
                                <input class="form-control" name="job_title_ar" type="text" value="{{old('job_title_ar')}}" placeholder="{{__('dashboard.job_title_ar')}}" >
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <a href="{{route('dashboard.testimonials.index')}}"><button type="button" class="btn btn-danger mr-1"><i class="icon-trash"></i>
